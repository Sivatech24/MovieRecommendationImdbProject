    ...
    <div className="app-container">
      ...
      <div className="movie-container">
        <div className="movie-header">
          <img
            src="https://i.ibb.co/C6MfLLh/moana2.jpg" // Replace with actual movie poster
            alt="Moana2 Poster"
          ...
          <div className="movie-details">
            ...
            Moana 2 is a 2024 American animated musical adventure film produced by Walt Disney Animation Studios for Walt Disney Pictures. It is the sequel to Moana (2016) and the second installment in the Moana franchise. The film was directed by David Derrick Jr., Jason Hand, and Dana Ledoux Miller (in their feature directorial debuts) and produced by Christina Chen and Yvett Merino, from a screenplay by Jared Bush and Miller. <br></br>  

            Auliʻi Cravalho, Dwayne Johnson, Temuera Morrison, Nicole Scherzinger, Rachel House, and Alan Tudyk all reprise their roles from the first film, with Hualālai Chung, Rose Matafeo, David Fane, Awhimai Fraser, Khaleesi Lambert-Tsuda, and Gerald Ramsey joining the cast.   <br></br>

            Set three years after the first Moana, it follows the titular character reuniting with the demigod Maui and assembling a wayfinding crew in order to find the lost island of Motufetu and break 1  its curse. 2 <br></br>
            </p>
            <br></br>
            <div className="tags">
        ...
        <div className="video-section">
          <h2>Moana2 | Official Trailer</h2>
          <iframe
            src="https://www.youtube.com/embed/hDZ7y8RP5HE?loop=1&autoplay=1&fs=0&modestbranding=1" // Replace with actual YouTube trailer
            title="Moana2 Trailer"
