...
const App = () => {
  ...
  const [name, setName] = useState("TheMerryGentlemen");  // Correctly initialize the state
    ...
    <div className="app-container">
      ...
      <div className="movie-container">
        <div className="movie-header">
          <img
            src="https://i.ibb.co/Z2Mb45s/The-Merry-Gentlemen.jpg" // Replace with actual movie poster
            alt="TheMerryGentlemen Poster"
            className="movie-poster"
          />
          <div className="movie-details">
            <h1>TheMerryGentlemen <span className="year">TheMerryGentlemen (2024)</span></h1>
            <p className="movie-description">
            To save her parents' small-town performing venue, a former big-city dancer decides to stage an all-male, Christmas-themed revue.<br></br>
            </p>
            <br></br>
            <div className="tags">
              <span>Holiday Romance</span>
        ...
        <div className="video-section">
          <h2>TheMerryGentlemen | Official Trailer</h2>
          <iframe
            src="https://www.youtube.com/embed/G80Q8-MJM1A?loop=1&autoplay=1&fs=0&controls=0&modestbranding=1" // Replace with actual YouTube trailer
            title="TheMerryGentlemen Trailer"
