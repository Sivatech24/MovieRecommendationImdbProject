...
const App = () => {
  ...
  const [name, setName] = useState("Conclave");  // Correctly initialize the state
    ...
    <div className="app-container">
      ...
      <div className="movie-container">
        <div className="movie-header">
          <img
            src="https://i.ibb.co/9NZHsYn/Conclave.jpg" // Replace with actual movie poster
            alt="Conclave Poster"
            className="movie-poster"
          />
          <div className="movie-details">
            <h1>Conclave <span className="year">Conclave (2024)</span></h1>
            <p className="movie-description">
            When Cardinal Lawrence is tasked with leading one of the world's most secretive and ancient events, selecting a new Pope, he finds himself at the center of a conspiracy that could shake the very foundation of the Catholic Church.<br></br>
            </p>
            <br></br>
            <div className="tags">
              <span>Drama</span>
              <span>Conspiracy Thriller</span>
              <span>Thriller</span>
            </div>
        ...
        <div className="video-section">
          <h2>Conclave | Official Trailer</h2>
          <iframe
            src="https://www.youtube.com/embed/JX9jasdi3ic?loop=1&autoplay=1&fs=0&modestbranding=1" // Replace with actual YouTube trailer
