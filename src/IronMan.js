...
const App = () => {
  ...
  const [name, setName] = useState("IronMan");  // Correctly initialize the state
    ...
    <div className="app-container">
      ...
      <div className="movie-container">
        <div className="movie-header">
          <img
            src="https://i.ibb.co/5M11sx2/IronMan.jpg" // Replace with actual movie poster
            alt="IronMan Poster"
            className="movie-poster"
          />
          <div className="movie-details">
            <h1>IronMan <span className="year">IronMan (2008)</span></h1>
            <p className="movie-description">
            Billionaire industrialist Tony Stark (Robert Downey Jr.) is kidnapped and forced to build a destructive weapon. Instead, he creates a high-tech suit of armor to escape and fight evil. This origin story marks the beginning of the Marvel Cinematic Universe, introducing the iconic superhero Iron Man. <br></br>
            </p>
            <br></br>
            <div className="tags">
              <span>Superhero</span>
        ...
        <div className="video-section">
          <h2>IronMan | Official Trailer</h2>
          <iframe
            src="https://www.youtube.com/embed/8ugaeA-nMTc?loop=1&autoplay=1&fs=0&modestbranding=1" // Replace with actual YouTube trailer
            title="IronMan Trailer"
