...
const App = () => {
  ...
  const [name, setName] = useState("Pushpa");  // Correctly initialize the state
    ...
    <div className="app-container">
      ...
      <div className="movie-container">
        <div className="movie-header">
          <img
            src="https://i.ibb.co/WpkRfzX/Pushpa.jpg" // Replace with actual movie poster
            alt="Pushpa Poster"
            className="movie-poster"
          />
          <div className="movie-details">
            <h1>Pushpa <span className="year">Pushpa 2 (2024)</span></h1>
            <p className="movie-description">
            Pushpa struggles to sustain his sandalwood smuggling business in the face of tough opposition from the police.<br></br>
            </p>
            <br></br>
            <div className="tags">
              <span>Superhero</span>
              <span>One Person Army Action</span>
              <span>Crime</span>
              <span>Action</span>
              <span>Drama</span>
              <span>Thriller</span>
        ...
        <div className="video-section">
          <h2>Pushpa | Official Trailer</h2>
          <iframe
            src="https://www.youtube.com/embed/HtmlDoXttNg?loop=1&autoplay=1&fs=0&controls=0&modestbranding=1" // Replace with actual YouTube trailer
            title="Pushpa Trailer"
