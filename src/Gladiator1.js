...
const App = () => {
  ...
  const [name, setName] = useState("Gladiator");  // Correctly initialize the state
    ...
    <div className="app-container">
      ...
      <div className="movie-container">
        <div className="movie-header">
          <img
            src="https://i.ibb.co/yP55dpy/gladiator1.jpg" // Replace with actual movie poster
            alt="Gladiator Poster"
            className="movie-poster"
          />
          <div className="movie-details">
            <h1>Gladiator <span className="year">Gladiator  (2024)</span></h1>
            <p className="movie-description">
            After his home is conquered by the tyrannical emperors who now lead Rome, Lucius is forced to enter the Colosseum and must look to his past to find strength to return the glory of Rome to its people.<br></br>
            </p>
            <br></br>
            <div className="tags">
              <span>Superhero</span>
        ...
        <div className="video-section">
          <h2>Gladiator | Official Trailer</h2>
          <iframe
            src="https://www.youtube.com/embed/4rgYUipGJNo?loop=1&autoplay=1&fs=0&modestbranding=1" // Replace with actual YouTube trailer
