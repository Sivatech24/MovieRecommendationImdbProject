...
const App = () => {
  ...
  const [name, setName] = useState("SnowWhite");  // Correctly initialize the state
    ...
    <div className="app-container">
      ...
      <div className="movie-container">
        <div className="movie-header">
          <img
            src="https://i.ibb.co/V3WThWT/Snow-White.jpg" // Replace with actual movie poster
            alt="SnowWhite Poster"
            className="movie-poster"
          />
          <div className="movie-details">
            <h1>SnowWhite <span className="year">SnowWhite (2025)</span></h1>
            <p className="movie-description">
            Live-action adaptation of the 1937 Disney animated film 'Snow White and the Seven Dwarfs'.<br></br>
            </p>
            <br></br>
            <div className="tags">
              <span>Family</span>
        ...
        <div className="video-section">
          <h2>SnowWhite | Official Trailer</h2>
          <iframe
            src="https://www.youtube.com/embed/iV46TJKL8cU?loop=1&autoplay=1&fs=0&controls=0&modestbranding=1" // Replace with actual YouTube trailer
            title="SnowWhite Trailer"
