...
const App = () => {
  ...
  const [name, setName] = useState("Moana2");  // Correctly initialize the state
    ...
    <div className="app-container">
      ...
      <div className="movie-container">
        <div className="movie-header">
          <img
            src="https://i.ibb.co/0mFszX8/dune.jpg" // Replace with actual movie poster
            alt="Dune 2 Poster"
            className="movie-poster"
          />
          <div className="movie-details">
            <h1>Moana 2 <span className="year">Moana 2 (2024)</span></h1>
            <p className="movie-description">
            The story is set in the distant future on the desert planet Arrakis, also known as Dune. Arrakis is the only source of the valuable spice melange, a substance that extends life and enhances mental abilities. The planet is controlled by the powerful House Harkonnen, but the noble House Atreides is given control of Arrakis by the Emperor.<br></br>

            The story follows Paul Atreides, a young man who is destined to become a powerful leader. He travels to Arrakis with his family, but they are betrayed and killed by the Harkonnens. Paul and his mother, Jessica, are forced to flee into the desert, where they are taken in by the Fremen, a native desert people.<br></br>

            Paul learns to survive in the harsh desert environment and becomes a powerful warrior. He also discovers that he has the ability to see the future, a power known as the Voice. With the help of the Fremen, Paul leads a rebellion against the Harkonnens and the Emperor, and eventually becomes the ruler of Arrakis.<br></br>
            </p>
            <br></br>
            <div className="tags">
              <span>Desert Adventure</span>
        ...
        <div className="video-section">
          <h2>Dune | Official Trailer</h2>
          <iframe
            src="https://www.youtube.com/embed/CzVHWNosS2o?loop=1&autoplay=1&fs=0&modestbranding=1" // Replace with actual YouTube trailer
            title="Dune Trailer"
