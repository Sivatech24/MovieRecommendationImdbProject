...
const App = () => {
  ...
  const [name, setName] = useState("OurLittleSecret");  // Correctly initialize the state
    ...
    <div className="app-container">
      ...
      <div className="movie-container">
        <div className="movie-header">
          <img
            src="https://i.ibb.co/m0ys75J/Our-Little-Secret.jpg" // Replace with actual movie poster
            alt="OurLittleSecret Poster"
            className="movie-poster"
          />
          <div className="movie-details">
            <h1>OurLittleSecret <span className="year">OurLittleSecret (2024)</span></h1>
            <p className="movie-description">
            Two resentful exes must awkwardly spend Christmas together after they learn that their new partners are siblings.<br></br>
            </p>
            <br></br>
            <div className="tags">
              <span>Holiday Comedy</span>
        ...
        <div className="video-section">
          <h2>OurLittleSecret | Official Trailer</h2>
          <iframe
            src="https://www.youtube.com/embed/fcc9G9PXTEE?loop=1&autoplay=1&fs=0&controls=0&modestbranding=1" // Replace with actual YouTube trailer
            title="OurLittleSecret Trailer"
