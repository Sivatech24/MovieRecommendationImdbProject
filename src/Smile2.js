...
const App = () => {
  ...
  const [name, setName] = useState("Smile2");  // Correctly initialize the state
    ...
    <div className="app-container">
      ...
      <div className="movie-container">
        <div className="movie-header">
          <img
            src="https://i.ibb.co/WGDxM5z/Smile-2.jpg" // Replace with actual movie poster
            alt="Smile2 Poster"
            className="movie-poster"
          />
          <div className="movie-details">
            <h1>Smile2 <span className="year">Smile2 (2024)</span></h1>
            <p className="movie-description">
            About to embark on a world tour, global pop sensation Skye Riley begins experiencing increasingly terrifying and inexplicable events. Overwhelmed by the escalating horrors and the pressures of fame, Skye is forced to face her past.<br></br>
            About to embark on a new world tour, global pop sensation Skye Riley (Naomi Scott) begins experiencing increasingly terrifying and inexplicable events. Overwhelmed by the escalating horrors and the pressures of fame, Skye is forced to face her dark past to regain control of her life before it spirals out of control.<br></br>
            The pop star Skye Riley is preparing for a tour after one year in a rehab clinic. Skye had a car crash with her boyfriend Paul Hudson, who died in the accident, and now she goes to the Drew Barrymore Show to promote her comeback. Her manager and mother Elizabeth Riley and her assistant Joshuatake care of her to avoid a drug relapse. However, Skye feels pain on her back due to the accident and visits her drug dealer Lewis Fregoli to buy the pain killer Vincodin to help her. She finds Lewis totally insane, unpredictable and unstable, and out of the blue, he smiles and hits his face several times with a weight plate. Skye flees and has several hallucinations and visions of smiling people. What is happening to her?<br></br>
            —Claudio Carvalho, Rio de Janeiro, Brazil<br></br>
            </p>
            <br></br>
            <div className="tags">
              <span>Psyhological Horror</span>
              <span>Showbiz Drama</span>
        ...
        <div className="video-section">
          <h2>Smile2 | Official Trailer</h2>
          <iframe
            src="https://www.youtube.com/embed/0HY6QFlBzUY?loop=1&autoplay=1&fs=0&controls=0&modestbranding=1" // Replace with actual YouTube trailer
            title="Smile2 Trailer"
