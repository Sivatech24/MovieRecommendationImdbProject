...
const App = () => {
  ...
  const [name, setName] = useState("Deadpool & Wolverine");  // Correctly initialize the state
  ...
  try {
    ...
    setName("Deadpool & Wolverine Poster");
    setEmail(user.email);
    ...
    <div className="app-container">
      ...
      <div className="movie-container">
        <div className="movie-header">
          <img
            src="https://i.ibb.co/pw7g16M/Deadpool-Wolverine.jpg" // Replace with actual movie poster
            alt="Deadpool & Wolverine Poster"
            className="movie-poster"
          />
          <div className="movie-details">
            <h1>Deadpool & Wolverine <span className="year">Deadpool & Wolverine (2024)</span></h1>
            <p className="movie-description">
            Deadpool is offered a place in the Marvel Cinematic Universe by the Time Variance Authority, but instead recruits a variant of Wolverine to save his universe from extinction.<br></br>
            </p>
            <br></br>
            <div className="tags">
              <span>Superhero</span>
              <span>Buddy Comedy</span>
        ...
        <div className="video-section">
          <h2>Deadpool & Wolverine | Official Trailer</h2>
          <iframe
            src="https://www.youtube.com/embed/73_1biulkYk?loop=1&autoplay=1&fs=0&modestbranding=1" // Replace with actual YouTube trailer
